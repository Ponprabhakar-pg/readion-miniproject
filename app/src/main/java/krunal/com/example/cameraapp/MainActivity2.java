...
public class MainActivity2 extends AppCompatActivity {
    ...
    private FloatingActionButton mClear,mSave,mShare,mStartCamera;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bName = getIntent().getStringExtra("a");
    ...
    private void processAndSetImage() {
        ...
        System.out.println(mTempPhotoPath);
        String im = getStringImage(mResultsBitmap);

        PyObject pyc = py.getModule("myScript");

        PyObject obj = pyc.callAttr("main",bName,im);
    ...
    private String getStringImage(Bitmap mResultsBitmap) {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        mResultsBitmap.compress(Bitmap.CompressFormat.PNG,100,baos);
